...
internal class PlayerHUD 
{
    ...
    public void Display()
    {
        ...
        else if (_player.Controller.Team == CsTeam.Spectator)
        {
            ...
            if (_player.IsSpectating(_player.CurrMap.ReplayManager.MapWR.Controller!))
                spec_replay = _player.CurrMap.ReplayManager.MapWR;
            else if (_player.IsSpectating(_player.CurrMap.ReplayManager.StageWR?.Controller!))
                spec_replay = _player.CurrMap.ReplayManager.StageWR!;
            else if (_player.IsSpectating(_player.CurrMap.ReplayManager.BonusWR?.Controller!))
                spec_replay = _player.CurrMap.ReplayManager.BonusWR!;
            else
                spec_replay = _player.CurrMap.ReplayManager.CustomReplays.Find(x => _player.IsSpectating(x.Controller!));
